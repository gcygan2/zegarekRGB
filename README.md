...
##Cechy
    1. Nie nosi się go na ręku, lecz stawia na biurku.
    2. Działa wyłącznie w zasięgu określonej sieci WiFi.
    3. Wymaga od użytkownika znajomości kodu barwnego (10 cyfr - 10 kolorów).
    4. Ma otwarty kod źródłowy (open source).
